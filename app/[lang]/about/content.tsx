...
export default function AboutContent({ dict }: AboutContentProps) {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground font-quilon overflow-hidden">
      ...
      <section className="relative h-[85vh] flex flex-col justify-center items-center px-4 overflow-hidden mb-24">
        ...
        >
          ...
          <motion.h1
            variants={fadeIn}
            className="text-[14vw] leading-[0.85] font-bold tracking-tighter text-foreground mb-2 mix-blend-overlay"
          >
            {dict.about.h1_title}
          </motion.h1>
          <motion.div
      ...
      <section className="container mx-auto px-6 md:px-12 mb-32 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-16 items-start">
          ...
          >
            <h2 className="text-2xl md:text-4xl lg:text-5xl font-light leading-tight text-foreground/80">
      ...
      <section className="container mx-auto px-6 md:px-12 mb-40 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <motion.div
            ...
            className="relative h-[400px] md:h-[600px] w-full bg-muted overflow-hidden flex items-center justify-center border border-border"
          >
            <div className="absolute inset-0 bg-emerald-900/20 mix-blend-color-dodge" />
            <div className="absolute w-[200%] h-[200%] bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-green-800/20 via-background to-background animate-slow-spin opacity-50" />
            <span className="text-[200px] font-bold text-foreground/5 absolute select-none">
              LIMÓN
            </span>
          </motion.div>
      ...
      {/* SECTION 4: TALENT HIGHLIGHT */}
      <section className="w-full py-24 bg-muted/30 border-y border-border mb-40 overflow-hidden">
      ...
      <section className="container mx-auto px-4 mb-32 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-1 bg-background p-1 border border-border">
          {[1, 2, 3, 4].map((item, index) => (
            <motion.div
              ...
              className="relative aspect-video group overflow-hidden bg-muted"
            >
              ...
              <div className="absolute inset-0 flex items-center justify-center pointer-events-none z-20">
                <div className="text-center opacity-70 group-hover:opacity-100 transition-opacity duration-300">
                  <div className="w-16 h-16 rounded-full border border-border backdrop-blur-sm flex items-center justify-center bg-background/20">
