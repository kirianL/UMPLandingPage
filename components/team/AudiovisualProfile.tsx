...
export default function AudiovisualProfile({
  artist,
  lang = "es",
  dict,
}: {
  ...
  return (
    <div className="min-h-screen bg-neutral-950 text-white selection:bg-red-600 selection:text-white font-sans">
      {/* HERO SECTION */}
      <section className="relative w-full min-h-screen flex flex-col pt-20 overflow-hidden">
        {/* Dither Background */}
        <div className="absolute inset-0 z-0 opacity-40">
          <Dither
            waveColor={[0.1, 0.6, 0.9]} // Blue/Sky dither color
            disableAnimation
        ...
        {/* Ambient Light - Gray Tint for Staff */}
        <div className="absolute inset-0 w-full h-full pointer-events-none select-none z-0 overflow-hidden mix-blend-soft-light">
          <div
            ...
            style={{
              background:
                "radial-gradient(circle at 50% -45%, rgba(14, 165, 233, 0.45) 0%, transparent 70%)",
            }}
          />
        </div>
          ...
          >
            <div className="space-y-6 lg:space-y-10">
              <motion.div
                ...
                className="inline-flex items-center gap-2 border-l-2 border-sky-500 pl-3"
              >
              ...
              >
                ...
                {/* Ocultamos género y producciones que no aplican usualmente al staff, a menos que sí tengan. 
                    Si tienen "releases", podríamos mostrar los proyectos, pero generalmente es un rol de equipo. */}
                {artist.releases && artist.releases.length > 0 && (
                  <div>
                    <h4 className="text-[10px] font-mono uppercase text-neutral-500 mb-1">
                      {dict.productions_label}
                    </h4>
                    <p className="text-sm font-bold uppercase tracking-wider">
          ...
          <div className="w-full md:col-span-7 lg:col-span-7 order-1 md:order-2 h-auto flex items-center justify-center md:justify-end mb-8 md:mb-0">
            <div className="relative w-full max-w-[280px] md:max-w-[300px] lg:max-w-[420px] xl:max-w-[500px] aspect-[3/4] md:aspect-[4/5] bg-neutral-900 overflow-hidden shadow-2xl shadow-black/50 border border-white/5 group">
              ...
              <div className="absolute top-4 left-4 z-30">
                <div className="h-2 w-12 bg-sky-500/80" />
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="bg-neutral-950 text-white py-12 sm:py-16 md:py-20 lg:py-32 relative overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none">
          ...
          <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-sky-900/10 rounded-full blur-[120px]" />
          <div
        ...
        <div className="container mx-auto px-4 relative z-10 grid md:grid-cols-12 gap-12">
          {/* Section Title */}
          <div className="md:col-span-3 border-t-4 border-sky-500 pt-4">
            <span className="block text-xs font-black uppercase tracking-widest mb-2 text-sky-500/70">
              {dict.chapter_1}
            </span>
          ...
          <div className="md:col-span-9 md:pl-12">
            <div className="relative">
              <div className="absolute -left-4 md:-left-8 top-0 h-full w-px bg-gradient-to-b from-sky-500/50 via-sky-500/20 to-transparent hidden md:block" />
              {/* Bio Logic: Prefer English if lang is 'en' and bio_en exists, else fallback to bio_es */}
              {lang === "en" && artist.bio_en ? (
                <div className="prose prose-invert prose-lg md:prose-xl max-w-none prose-headings:font-black prose-headings:text-white prose-p:text-neutral-300 prose-p:leading-relaxed prose-p:font-light prose-strong:text-white prose-strong:font-bold prose-a:text-sky-500 prose-a:no-underline hover:prose-a:underline">
                  <p className="first-letter:text-7xl first-letter:font-black first-letter:float-left first-letter:mr-4 first-letter:mt-[-10px] first-letter:text-sky-500">
                    {artist.bio_en.split("\n")[0]}
                  </p>
                  {artist.bio_en
                    .split("\n")
              ...
              {artist.bio_es && (
                <div className="mt-12 pt-8 border-t border-white/10 grid grid-cols-2 gap-6">
                  <div className="text-center md:text-left">
                    <div className="text-3xl md:text-4xl font-black text-sky-500">
