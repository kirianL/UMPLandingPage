...
export default function DJProfile({ artist }: { artist: ArtistWithReleases }) {
  ...
  return (
    <div className="min-h-screen bg-neutral-950 text-white selection:bg-purple-500 selection:text-white font-sans">
      {/* HERO SECTION */}
      <section className="relative w-full min-h-screen flex flex-col pt-20 overflow-hidden">
        ...
        {/* Ambient Light - Purple Tint for DJ */}
        <div className="absolute inset-0 w-full h-full pointer-events-none select-none z-0 overflow-hidden">
          <div
            className="absolute inset-0 w-full h-full"
            style={{
              background:
                "radial-gradient(circle at 50% -45%, rgba(147, 51, 234, 0.45) 0%, transparent 70%)",
            }}
          />
        </div>
        ...
        <div className="container mx-auto px-4 md:px-6 lg:px-12 flex-1 grid grid-cols-1 md:grid-cols-12 items-center relative z-10 pt-4 sm:pt-6 md:pt-0 pb-8 sm:pb-12 gap-6 md:gap-8 lg:gap-16 xl:gap-24">
          ...
          <div className="w-full md:col-span-5 lg:col-span-5 order-2 md:order-1 flex flex-col justify-end pb-8 md:pb-0">
            <div className="space-y-6 lg:space-y-10">
              <div className="inline-flex items-center gap-2 border-l-2 border-purple-500 pl-3">
              ...
              <div className="flex flex-wrap gap-6 pt-4 lg:pt-6">
                ...
                <Link
                  href="#sessions"
                  className="text-neutral-400 hover:text-[#ff7700] transition-colors duration-300"
                >
                  <FaSoundcloud className="h-8 w-8" />
                </Link>
                {artist.youtube_url && (
                  <a
      ...
      <section className="bg-neutral-950 text-white py-12 sm:py-16 md:py-20 lg:py-32 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10 grid md:grid-cols-12 gap-12">
          {/* Section Title */}
          <div className="md:col-span-3 border-t-4 border-purple-500 pt-4">
            <span className="block text-xs font-black uppercase tracking-widest mb-2 text-purple-500/70">
              Capítulo I
            </span>
              ...
              {artist.bio_es && (
                <div className="mt-12 pt-8 border-t border-white/10 grid grid-cols-2 md:grid-cols-3 gap-6">
                  <div className="text-center md:text-left">
                    <div className="text-3xl md:text-4xl font-black text-purple-500">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-x-3 gap-y-6 sm:gap-x-4 sm:gap-y-8 md:gap-6 lg:gap-8">
            {artist.releases?.map((release, index) => (
              <div key={release.id} className="group flex flex-col gap-3">
                ...
                <div>
                  <h3 className="text-sm md:text-base font-bold text-white uppercase leading-tight line-clamp-1 group-hover:text-purple-500 transition-colors">
                    {release.title}
                  </h3>
