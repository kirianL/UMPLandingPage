        ...
        <div className="absolute left-6 md:left-12 right-6 md:right-12 bottom-8 md:bottom-12 z-30 flex flex-col md:flex-row items-center md:items-end justify-between gap-6 pointer-events-none">
          ...
          >
            ...
            {artist.apple_music_url && (
              <a href={artist.apple_music_url} target="_blank" rel="noreferrer" className={`text-[10px] md:text-xs font-mono tracking-[0.2em] ${themeText} hover:text-white uppercase transition-colors`}>
                [ APPLE MUSIC ]
              </a>
            )}
            {artist.youtube_url && (
