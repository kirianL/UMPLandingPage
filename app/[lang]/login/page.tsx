...
export default function LoginPage() {
  ...
  return (
    <div className="flex min-h-screen bg-background text-foreground overflow-hidden">
        ...
        <div className="w-full max-w-md mx-auto space-y-8">
          ...
          <div className="space-y-2">
            <div className="flex items-center gap-3 mb-6">
              <div className="h-8 w-8 bg-foreground/10 rounded-full flex items-center justify-center">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  required
                  className="bg-muted/50 border-border text-foreground placeholder:text-muted-foreground h-12 focus:border-primary/50 focus:ring-primary/20 transition-all"
                />
              </div>
      ...
      <div className="hidden lg:flex w-1/2 bg-muted/30 relative items-center justify-center overflow-hidden border-l border-border">
        {/* Abstract Background Elements */}
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] from-muted/50 to-background z-0" />
